...
from .views import HomePageView, AboutPageView, ContactPageView, ProductIndexView, ProductShowView, ProductCreateView, SuccessView, CartView, CartRemoveAllView, ImageViewFactory, ImageViewNoDI
